...
@Controller
@RequestMapping("/user")
 @PreAuthorize("hasAuthority('ADMIN')")             //возможности введения доступа только Админа
public class UserController {                     //этот К создан для возможности введения доступа только Админа
    @Autowired
